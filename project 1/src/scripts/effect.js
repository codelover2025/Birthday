...
$('document').ready(function(){
	...
	$('#invite_friends').click(function(){
		...
		$('#self').css({"display": "block", "top": mid + 'px', "left": vw + 'px'});
		$('#self').animate({top: mid - mid_diff * 2, left: vw}, 3000);
	
		$('#f1').css({"display": "block", "top": mid - mid_diff * 4, "left": vw - vw_diff * 3});
		$('#f1').animate({top: mid - mid_diff * 3, left: vw - vw_diff * 3}, 3000);
	
		$('#f2').css({"display": "block", "top": mid - mid_diff * 4, "left": vw});
		$('#f2').animate({top: mid - mid_diff * 3, left: vw}, 3000);
	
		$('#f3').css({"display": "block", "top": mid - mid_diff * 4, "left": vw + vw_diff * 3});
		$('#f3').animate({top: mid - mid_diff * 3, left: vw + vw_diff * 3}, 3000);
	
		$('#f4').css({"display": "block", "top": mid - mid_diff * 2, "left": vw - vw_diff * 3});
		$('#f4').animate({top: mid - mid_diff, left: vw - vw_diff * 3}, 3000);
	
		$('#f5').css({"display": "block", "top": mid - mid_diff * 2, "left": vw});
		$('#f5').animate({top: mid - mid_diff, left: vw}, 3000);
	
		$('#f6').css({"display": "block", "top": mid - mid_diff * 2, "left": vw + vw_diff * 3});
		$('#f6').animate({top: mid - mid_diff, left: vw + vw_diff * 3}, 3000);
	
		$('#f7').css({"display": "block", "top": mid, "left": vw - vw_diff * 3});
		$('#f7').animate({top: mid + mid_diff, left: vw - vw_diff * 3}, 3000);
	
		$('#f8').css({"display": "block", "top": mid, "left": vw});
		$('#f8').animate({top: mid + mid_diff, left: vw}, 3000);
	
		$('#f9').css({"display": "block", "top": mid, "left": vw + vw_diff * 3});
		$('#f9').animate({top: mid + mid_diff, left: vw + vw_diff * 3}, 3000);
	
		$('#f10').css({"display": "block", "top": mid + mid_diff * 2, "left": vw - vw_diff * 3});
		$('#f10').animate({top: mid + mid_diff * 3, left: vw - vw_diff * 3}, 3000);
	
		$('#f11').css({"display": "block", "top": mid + mid_diff * 2, "left": vw});
		$('#f11').animate({top: mid + mid_diff * 3, left: vw}, 3000);
	
		$('#f12').css({"display": "block", "top": mid + mid_diff * 2, "left": vw + vw_diff * 3});
		$('#f12').animate({top: mid + mid_diff * 3, left: vw + vw_diff * 3}, 3000);
